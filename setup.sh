...
show_access_info() {
    ...
    log "INFO" "  Open WebUI:     http://192.168.50.128:8189"
    log "INFO" "  ComfyUI:        http://192.168.50.128:8188"
    log "INFO" "  Model Manager:  http://192.168.50.128:8191"
    log "INFO" "  OpenRouter:     http://192.168.50.128:8190"
    echo ""
    log "INFO" "Proxy Access (for Organizr embedding):"
    log "INFO" "  Open WebUI:     http://192.168.50.128:8161"
    log "INFO" "  ComfyUI:        http://192.168.50.128:8162"
    log "INFO" "  Model Manager:  http://192.168.50.128:8164"
    log "INFO" "  OpenRouter:     http://192.168.50.128:8163"
    echo ""
